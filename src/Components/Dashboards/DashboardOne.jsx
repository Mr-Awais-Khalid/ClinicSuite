        ...
        <div className="grid grid-cols-9 gap-x-4">
          ...
          >
            <div className="text-right mb-1">
              <span className="bg-orange-100 text-orange-300 text-sm rounded-full px-3 py-1">
                Create
              </span>
              ...
              <p className="text-sm text-gray-500">
                Create the perfect Doc or wiki with nested pages, styling
          ...
          <div className="relative col-span-1 flex items-center justify-center">
            {/* Timeline Icon */}
            <motion.div
              className="absolute w-10 h-10 bg-blue-500 rounded-full flex items-center justify-center backdrop-blur-lg text-white"
              initial={{ scale: 0 }}
          ...
          {/* Timeline item 3 */}
          <motion.div
            ref={ref3} // Attach ref to this item
            className="col-span-4 pb-10"
            initial={{ opacity: 0, x: -50 }}
